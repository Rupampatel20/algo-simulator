      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="hover:text-green-600 transition-all duration-300 cursor-pointer"><a target="_blank" href="https://www.geeksforgeeks.org/searching-algorithms/">How Searching Works</a></li>
